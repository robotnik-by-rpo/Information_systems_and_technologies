...
cursor.execute("INSERT OR IGNORE INTO level_education (id_level, title_ed) VALUES (1, 'Бакалавриат')")
cursor.execute("INSERT OR IGNORE INTO level_education (id_level, title_ed) VALUES (2, 'Магистратура')")
cursor.execute("INSERT OR IGNORE INTO level_education (id_level, title_ed) VALUES (3, 'Аспирантура')")

cursor.execute("INSERT OR IGNORE INTO way (id_way, title_way) VALUES (1, 'Прикладная_информатика')")
cursor.execute("INSERT OR IGNORE INTO way (id_way, title_way) VALUES (2, 'Управление_персоналом')")
cursor.execute("INSERT OR IGNORE INTO way (id_way, title_way) VALUES (3, 'Реклама_и_связь_с_общественностью')")
cursor.execute("INSERT OR IGNORE INTO way (id_way, title_way) VALUES (4, 'Сервис')")
cursor.execute("INSERT OR IGNORE INTO way (id_way, title_way) VALUES (5, 'Туризм')")
cursor.execute("INSERT OR IGNORE INTO way (id_way, title_way) VALUES (6, 'Экономика')")

cursor.execute("INSERT OR IGNORE INTO type_education (id_type, title_type) VALUES (1, 'Очный')")
cursor.execute("INSERT OR IGNORE INTO type_education (id_type, title_type) VALUES (2, 'Заочный')")
cursor.execute("INSERT OR IGNORE INTO type_education (id_type, title_type) VALUES (3, 'Вечерний')")
